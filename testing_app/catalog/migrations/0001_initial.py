    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.Task')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='task',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.Task'),
        ),
        migrations.AddField(
            model_name='solutioninstance',
            name='user',
